            ...
            <Card className="w-full max-w-md border border-white/5  backdrop-blur-xl shadow-2xl p-4">
                <CardHeader className="flex flex-col gap-1 items-center pb-6 text-center">
                    ...
                    <p className="text-slate-400 text-sm mt-1">
                       Access your RecipeHub account and purchase event tickets.
                    </p>
                </CardHeader>
                <CardBody className="gap-4">
                    <Form
                        ...
                        <Input
                            ...
                            className="w-full bg-slate-900/50 border-white/10  focus-within:!border-pink-500"
                        />

                        <Button
                            type="submit"
                            className="w-full bg-gradient-to-r from-orange-500 to-red-500 text-white font-bold h-12 shadow-lg shadow-pink-500/10 hover:shadow-pink-500/20"
                            radius="lg"
                        >
                            Sign In
                        </Button>
