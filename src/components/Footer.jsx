...
import { FaTicketAlt, FaFacebook, FaTwitter, FaInstagram, FaGithub, FaUtensils } from "react-icons/fa";
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div className="space-y-4">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-extrabold text-lg tracking-tight bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">
              RecipeHub
            </span>
          </Link>
          <p className="text-slate-400 text-sm leading-relaxed">
RecipeHub is a modern recipe sharing platform where food lovers can easily create, share, and discover new recipes.          </p>
